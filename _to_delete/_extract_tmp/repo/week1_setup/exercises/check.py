"""
Traceback safari - marker.

    python check.py

Runs each exercise and tells you whether it is fixed. It does not tell you how
to fix anything. Read the traceback: the last line says what went wrong, the
line above it says where.
"""
...
def main():
    ...
    if passed == len(EXPECTED):
        print("All six. You can now read a traceback, which is most of debugging.")
    else:
        print("Keep going. Run one file at a time and read the last line of the error.")
    print("=" * 64)
