...
This is what came back from:

    "analyse this traffic data and tell me the average speed on each link"

It runs. It has a docstring. It is formatted nicely. It prints a professional
looking table with one decimal place.

It is wrong.

Do not fix this file. It is kept broken on purpose so we can come back to it.
"""
